        ...
        <v-row align="center" justify="center">
          <v-col cols="12" sm="8" md="4">
            <v-card class="elevation-12">
              ...
              <v-card-text>
                <v-form autocomplete="false" v-model="valid" ref="form" lazy-validation>
                  <v-text-field
...
export default {
  ...
  data: () => ({
    ...
    rules: {
      ...
      personalid: value =>
        (value && value.length == 13) || "Personal ID must be 13 characters",
      phone: value =>
        (value && value.length == 10) || "phone must be 10 characters"
    }
  }),
  computed: {
    ...mapState({
